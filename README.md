...
1. Explain what a token is used for.
  ...
  A token is used to give access to a secure page

2. What steps can you take in your web apps to keep your data secure?

  Do not use your personal computer as a host server. Use passwords to protect information. Store Username and password info on a secure server
...
4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
  Post = Create, Get = Read, Post = Update, Delete = Destroy/Delete
